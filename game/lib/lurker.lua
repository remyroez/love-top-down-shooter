...
local isdir = love.filesystem.getInfo and function (path) return (love.filesystem.getInfo(path) or {}).type == 'directory' end or love.filesystem.isDirectory
local time = love.timer.getTime or os.time
local lastmodified = love.filesystem.getInfo and function (path) return (love.filesystem.getInfo(path) or {}).modtime end or love.filesystem.getLastModified
